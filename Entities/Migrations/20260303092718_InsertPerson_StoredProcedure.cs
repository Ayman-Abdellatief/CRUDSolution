...
namespace Entities.Migrations
{
    ...
    public partial class InsertPerson_StoredProcedure : Migration
    {
        ...
        {
            var sp_InsertPerson = @"CREATE  PROCEDURE [dbo].[InsertPerson]
                       (@PersonID uniqueidentifier ,@PersonName nvarchar(50), @Email nvarchar(50),@DateOfBirth datetime2(7),
                         @Gender varchar(10) , @CountryID uniqueidentifier ,@Address nvarchar(100),@ReceiveNewsLetters bit )
                    AS
                    BEGIN
